import { db,storageRef } from "../util/firebase";
...
export const postOneScream = async screamBody => {
	...
	console.log(screamBody.image[0].name, "this is image")
	// if (screamBody.image[0]) {
	// 	console.log("clicked ", )
	//   const uploadTask = storageRef.ref(`images/${screamBody.image[0].name}`).put(screamBody.image[0]);
	...
	// 		});
	// 		console.log(screamBody.image[0].name,)
	...
	//   );
	// }
// console.log(uploadTask,99999)

	if (screamBody.post.trim() === "") throw new Error("Must not be empty");
